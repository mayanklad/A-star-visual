...
def onsubmit():
    global start
    global end
    st = [startBox_x.get(), startBox_y.get()]
    ed = [endBox_x.get(), endBox_y.get()]
...
label_x = Label(window, text='Start  x:')
startBox_x = Entry(window)
label_y = Label(window, text='y:')
startBox_y = Entry(window)
label1_x = Label(window, text='End   x:')
endBox_x = Entry(window)
label1_y = Label(window, text='y:')
endBox_y = Entry(window)
var = IntVar()
...
submit.grid(columnspan=2, row=3, pady=3)
label1_x.grid(row=1, pady=3)
label1_y.grid(row=1, column=2)
endBox_x.grid(row=1, column=1, padx=3, pady=3)
endBox_y.grid(row=1, column=3, padx=3, pady=3)
startBox_x.grid(row=0, column=1, padx=3, pady=3)
startBox_y.grid(row=0, column=3, padx=3, pady=3)
label_x.grid(row=0, pady=3)
label_y.grid(row=0, column=2, pady=3)
